...
class Window:
    ...
    def creatui(self):
        ...
        self.radio2 = tkinter.Radiobutton(self.root, variable=self.v1, value='https', text='https').grid(row=0,column=2)
        ...
        self.radio4 = tkinter.Radiobutton(self.root, variable=self.v2, value='https', text='https').grid(row=0,column=5)
        # 第二行
